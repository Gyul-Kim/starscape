	...
	function(data){
		...
		if(type == "Y"){
			$.each(data.result,function(key,val){
				var P03_WEEK_PRCE = val["P01_WEEK_PRCE"].slice(0,-4);
				var P03_FRD_PRCE = val["P01_FRD_PRCE"].slice(0,-4);
				var P03_SAT_PRCE = val["P01_SAT_PRCE"].slice(0,-4);
				...
				$("table#ROOM_CODE tbody").append(
					...
					+ "<td> "+ P03_WEEK_PRCE + "만원</td><td>" + P03_FRD_PRCE + "만원</td><td>" + P03_SAT_PRCE + "만원</td>"
